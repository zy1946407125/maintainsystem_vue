...
<script>
    ...
    // const BASE_URL = 'http://localhost:8081/maintainSystem'; // 设置全局 URL   开发环境
    ...
    // const BASE_URL = 'https://wx.hngayjy.com/maintainSystem'; // 设置全局 URL   真实环境
    const BASE_URL = 'https://magic233.top/maintainSystem'; // 设置全局 URL   测试环境
    export default{
        BASE_URL
    }
